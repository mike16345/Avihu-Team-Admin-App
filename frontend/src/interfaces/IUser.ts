...
export interface IStatusHistoryEntry {
  /** ISO timestamp of the change/note. */
  at: Date | string;
  /**
   * "system" — entry auto-generated by a status change.
   * "manual" — free-form note typed by the trainer; status fields
   *   describe the trainee's status at the time the note was added
   *   (or stay equal to denote "no change").
   * Defaults to "system" for backwards compatibility with entries
   ...
   */
  daysAdded?: number;
  /** Free-form trainer note attached to this event. */
  note?: string;
}
