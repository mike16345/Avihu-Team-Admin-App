import { FaMagnifyingGlass, FaSliders, FaStar } from "react-icons/fa6";
import {
  getFavoritesButtonClassName,
  getFavoritesCountClassName,
} from "./workoutPresetPickerUtils";

type WorkoutPresetPickerToolbarProps = {
  search: string;
...
const WorkoutPresetPickerToolbar = ({
  search,
  onSearchChange,
  filteredCount,
  totalCount,
  ...
  onToggleFilters,
  activeChipCount,
}: WorkoutPresetPickerToolbarProps) => (
...
export default WorkoutPresetPickerToolbar;
